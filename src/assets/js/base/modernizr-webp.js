                ...
                if (r.hasOwnProperty(f)) {
                    ...
                    for (a = o(n.fn, "function") ? n.fn() : n.fn, t = 0; t < e.length; t++)
                        (i = e[t]),
                            ...
                            1 === l.length
                                ? (Modernizr[l[0]] = a)
                                : (!Modernizr[l[0]] || Modernizr[l[0]] instanceof Boolean || (Modernizr[l[0]] = new Boolean(Modernizr[l[0]])), (Modernizr[l[0]][l[1]] = a)),
                            s.push((a ? "" : "no-") + l.join("-"));
                }
        }
        function t(e) {
        ...
        function i(e, n) {
            if ("object" == typeof e) for (var A in e) f(e, A) && i(A, e[A]);
                ...
                (n = "function" == typeof n ? n() : n),
                    1 == o.length ? (Modernizr[o[0]] = n) : (!Modernizr[o[0]] || Modernizr[o[0]] instanceof Boolean || (Modernizr[o[0]] = new Boolean(Modernizr[o[0]])), (Modernizr[o[0]][o[1]] = n)),
                    t([(n && 0 != n ? "" : "no-") + o.join("-")]),
